...
| [`apps/stocks/CHANGELOG.md`](apps/stocks/CHANGELOG.md) | Sage Stocks, a separate product on its own release cadence | Keep a Changelog · SemVer |
| `apps/portfolio/`, `apps/creative-powerup/` | **dormant.** Generated by changesets, which has since been removed; last written 2026-02-16 and still naming the retired `@thesage/ui`. Left in place as release history, not maintained. | generated |
| [opencosmos-ui](https://github.com/shalomormsby/opencosmos-ui) | the design system — component behaviour and its releases | dated narrative |
