...
| [0016](0016-the-i-ching-is-read-through-the-wings-and-the-lens-is-declared.md) | **The I Ching is read through the Wings, and the lens is declared** | Proposed | Fixes which book `iching/` is translating, and requires the interpretive lens to be stated in the front matter rather than operating invisibly. |
