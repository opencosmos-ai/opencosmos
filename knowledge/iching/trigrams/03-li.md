...
Lines `101`, bottom to top. The Shuogua associates it with 火.

**Rendered `fire`** — the ruling and its argument are in [`../glossary/離-li.md`](../glossary/離-li.md). `status: draft` until Shalom locks it. The image is a textual fact; its English is not, and the two are
