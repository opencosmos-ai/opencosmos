---
title: "Bhagavad-Gita — Entity Summary"
role: wiki
domain: vedic
confidence: medium
status: active
...
open_questions:
  ...
  - Does the Gita's teaching on non-attachment to fruits of action (nishkama karma) lead to the same practical conclusion as Buddhist non-attachment to outcomes?
contradictions:
  - The Gita teaches ahimsa (non-harm) as a virtue but instructs Arjuna to fight and kill — including his own teachers and kinsmen. Krishna's resolution (the soul is indestructible; only the body dies) is either a brilliant solution or a rationalization for violence.
  - Arjuna's initial refusal to fight could be read as the most ethical position in the dialogue — a spontaneous nonviolent response to unnecessary war. Krishna overrules it. Thoreau and Tolstoy would be on Arjuna's side; Krishna would not.
---
